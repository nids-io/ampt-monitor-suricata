'''
AMPT Monitor plugin for Suricata logs setup
...
setup(
    ...
    version='0.3.0',
    description='ampt-monitor plugin to read healthcheck alerts from the Suricata event logs',
    long_description=long_description,
    url='https://github.com/nids-io/ampt-monitor-suricata',
    author='AMPT Project',
    ...
    keywords='ampt, ampt-monitor, ampt-monitor-suricata, suricata, eve, a passive network health monitoring tool',
    ...
    entry_points={
        ...
        'ampt_monitor.plugin': [
            ...
            'suricata = ampt_monitor_suricata.plugin:SuricataAMPTMonitor',
        ],
    },
)
